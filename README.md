...
The query boundary provides bounded search, price/room/area ranges, property
type and country filters, energy-rating filters, score thresholds, and
featured-listing selection for all presentation adapters.
