...
final class PropertiesCapabilityDefinition
{
    ...
    {
        $labels = ['Address/location', 'Categories', 'Templates', 'Favorites', 'Saved searches', 'Units', 'Characteristics', 'Tenure', 'Utilities', 'Features', 'Status', 'History', 'Keys', 'Property detail disclosures', 'Property comparisons', 'Property tax estimates'];
        $result = [];
